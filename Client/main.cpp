...
enum {
    ...
    VJOY_CTRL_RTRIGGER     = 1 << 8,	//!< Right Trigger button.
	VJOY_CTRL_LTRIGGER     = 1 << 9,	//!< Left Trigger button.
    VJOY_CTRL_RIGHT     = 1 << 10,	//!< Right button.
	VJOY_CTRL_LEFT    = 1 << 11,	//!< Left button.
    VJOY_CTRL_UP     = 1 << 12,	//!< Up button.
	VJOY_CTRL_DOWN    = 1 << 13,	//!< Down button.
};
#endif
	...
	for (;;){
		...
		if (count != 0){
			...
			if (VJOY_MODE)
			{
				...
				{
					buttons = buttons | VJOY_CTRL_LEFT;
				}
				else if (data.buttons & SCE_CTRL_RIGHT)
				{
					buttons = buttons | VJOY_CTRL_RIGHT;
				}
				if (data.buttons & SCE_CTRL_UP)
				{
					buttons = buttons | VJOY_CTRL_UP;
				}
				else if (data.buttons & SCE_CTRL_DOWN)
				{
					buttons = buttons | VJOY_CTRL_DOWN;
				}
				...
				{
					buttons = buttons | VJOY_CTRL_RTRIGGER;
				}
				if (data.buttons & SCE_CTRL_LTRIGGER)
				{
					buttons = buttons | VJOY_CTRL_LTRIGGER;
				}
